...
Сценарий: Смотрим возможности автоинструкции в версии VA 1.2.037.1
...
И я добавляю произвольный текст в автоинструкцию 
  | ' ## Пользовательская инструкция для конфигураций: '    |
  | ' ### 1С:ERP версии: 2_5_9_125 '                        |
  | ' ### 1С:Комплексная автоматизация версии: 2_4_13_209 ' |
  | ' ### 1С:Управление торговлей версии: 11_5_7_402 '      |

// Добавляем логотип Vanessa Automation.
И я добавляю произвольный текст в автоинструкцию
        | ' ![Vanessa Automation][logo] '                                                       |
        | ''                                                                           |
        | ' [logo]: ../VA.png "Vanessa Automation" ' |
...
// оглавление. 2 проблеа для воложенности оглавления
И я добавляю произвольный текст в автоинструкцию
        | ' <a id="header" /> '                                                         |
        | ''                                                                            |
        | ' ## Оглавление '                                                             |
        ...
        | '***'                                                                         |
        | ''                                                                            |
        | ' * <a href="#Chapter1">Сценарий замены картинки</a> '            |
        | ' * <a href="#Chapter2">Демонстрация не использованных возможностей</a> '                 |
        | ''                                                                            |
...
// ссылка на оглавление и якорь первого раздела
И я добавляю произвольный текст в автоинструкцию
        | ''                                          |
        | ' * <a href="#header">Оглавление</a> '      |
        | ''                                          |
        | ' <a id="Chapter1" /> '                     |
        | ''                                          |
        | ' ## Сценарий замены картинки ' |
        | ''                                          |
        | '***'                                       |
        | ''                                          |
...
// Ссылка на оглавление и якорь второго раздела
И я добавляю произвольный текст в автоинструкцию
        | ''                                          |
        | ' * <a href="#header">Оглавление</a> '      |
        | ''                                          |
        | ' <a id="Chapter2" /> '                     |
        | ''                                          |
        | ' ## Демонстрация не использованных возможностей ' |
        | ''                                          |
        | '***'                                       |
        | ''                                          |
