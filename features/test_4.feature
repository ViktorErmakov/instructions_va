...
Сценарий: Смотрим возможности автоинструкции в версии VA 1.2.039.15
...
И я добавляю заголовок в автоинструкцию 
	|'Заголовок'|'Пользовательская инструкция для конфигураций:'|
	|'Уровень  '|'2'|

И я добавляю заголовок в автоинструкцию 
	|'Заголовок'|'1С:ERP версии: 2_5_9_125'|
	|'Уровень  '|'3'|

И я добавляю заголовок в автоинструкцию 
	|'Заголовок'|'1С:Управление торговлей версии: 11_5_7_402'|
	|'Уровень  '|'3'|
...
И я добавляю нумерованное оглавление в автоинструкцию
	...
	|'#chapter1'|'Сценарий замены картинки                   '|'                 '|
	|'#chapter2'|'Демонстрация не использованных возможностей'|'                 '|
	|'#chapter3'|'Подглава раздела 2                         '|'#chapter2        '|
...
И я добавляю заголовок в автоинструкцию 
	|'Заголовок'|'Сценарий замены картинки'|
	|'Уровень  '|'2'|
...
#[autodoc.ignorestep]
И пауза 3
#[autodoc.text]  Конфигурация "Демонстрационное приложение (1.0.35.1)"
И пауза 5
...
И я рисую рамку вокруг элемента панели разделов "Продажи" в браузере
	...
	|'size'|'3'|
	|'timeout'|'3000'|
#[autodoc.text]  Рисуем красную рамку вокруг элемента панели раздов "продажи"
И Пауза 3
...
#[autodoc.ignorestep]
И пауза 1
#[autodoc.text]  Поиск элемента по координатам сохраненной картинки, используется когда нужно работать с элементами которых нет на формах.
И пауза 3
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Показываю подсказку EnjoyHint у элемента
И Пауза 5
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Показываю текст над полем.
И Пауза 3
...
#[autodoc.ignorestep]
И пауза 1
#[autodoc.text]  Показываю подсказку DriverJs у элемента.
И пауза 5
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Перехожу к строке товара с наименованием "Валенки 2" - рисую рамку вокруг ячеек таблицы
И Пауза 5
...
#[autodoc.ignorestep]
И пауза 1
#[autodoc.text]  Поиск элемента по координатам сохраненной картинки
И пауза 3
...
И я добавляю заголовок в автоинструкцию 
	|'Заголовок'|'Демонстрация не использованных возможностей'|
	|'Уровень  '|'2'|
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Демонстрация: рисую стрелку от элемента к другому элементу формы
И Пауза 3
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Демонстрация: рисую красную рамку вокруг нескольких элементов.
И Пауза 5
...
#[autodoc.ignorestep]
И Пауза 1
#[autodoc.text]  Демонстрация: выделяю несколько элементов с одной подсказкой EnjoyHint.
И Пауза 3
...
#[autodoc.text]  Демонстрация: когда нужно скрыть от пользователей конфиденциальную информацию затеняем данные - накладываю эффект размытия
И Пауза 3			
